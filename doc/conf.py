...
exclude_patterns = ['_build', 'whatsnew','images']
...
if 'READTHEDOCS' in os.environ:
    ...
    MOCK_MODULES = ['numpy', 'scipy', 'pandas.dataframe', 'pypsa']
...
latex_documents = [
  (master_doc, 'ego.tex', u'eGo Documentation',
...
man_pages = [
    (master_doc, 'eGo', u'eGo Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'eGo', u'eGo Documentation',
   author, 'Ego', 'Integrated optimization of flexibility options and grid extension measures for power grids based on eTraGo and eDisGo.',
   'Miscellaneous'),
]
