...
eGo lives at github: https://github.com/openego/eGo/
...
extlinks = {
    "pandas": ("http://pandas.pydata.org/pandas-docs/stable/api.html#%s", "pandas."),
    "sqlalchemy": (
...
latex_documents = [
    (master_doc, "eGo.tex", "eGo Documentation", r"open\_eGo-Team", "manual"),
]
...
intersphinx_mapping = {
    ...
    "etrago": ("https://etrago.readthedocs.io/en/latest", None),
